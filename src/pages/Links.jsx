...
const Links = ({ darkMode, setDarkMode }) => {
  ...
  const linksList = [
    ...
    { name: "ReduxToolKitDoc" , url: "https://redux-toolkit.js.org/" },
    ...
    { name: "JSONServer", url: "https://www.npmjs.com/package/json-server"},
    { name: "YouTube", url: "https://www.youtube.com/"},
    { name: "TypeScript", url: "https://www.typescriptlang.org/"},
    { name: "JavaScript", url: "https://www.javascripttutorial.net/"},
    { name: "ReduxNotion", url: "https://protective-niece-599.notion.site/Redux-Redux-Toolkit-27b936d37d8880f2acfddda7f82cddd8"},
    { name: "ReduxDoc", url: "https://redux.js.org/"},
    { name: "ReduxToolKit", url: "https://www.npmjs.com/package/@reduxjs/toolkit"},
    { name: "FrontTutorialPro", url: "https://front-tutorial-pro-2.vercel.app/"},
    { name: "TablerIcons", url: "https://tabler.io/icons"},
    { name: "PhosphorIcons", url: "https://phosphoricons.com/"},
    { name: "LoremIpsumPhotos", url: "https://picsum.photos/"},
    { name: "TMDB API", url: "https://developer.themoviedb.org/docs/getting-started"},
    { name: "Unsplash API", url: "https://unsplash.com/developers"},
    { name: "DummyJSON", url: "https://dummyjson.com/"},
    { name: "Zustand", url: "https://zustand.docs.pmnd.rs/learn/getting-started/introduction"},
    { name: "ReactHookForm", url: "https://react-hook-form.com/"},
    { name: "Zod", url: "https://zod.dev/"},
    { name: "ReduxDevTools", url: "https://github.com/reduxjs/redux-devtools"},
    { name: "Vitest", url: "https://vitest.dev/"},
    { name: "Cypress", url: "https://www.cypress.io/#create"},
    { name: "FlyIo", url: "https://fly.io/"},
    { name: "LeetCode", url: "https://leetcode.com/"},
    { name: "HackerRank", url: "https://www.hackerrank.com/"},
    { name: "DevChallenges", url: "https://devchallenges.io/"},
    { name: "Cursor", url: "https://cursor.com/"},
    { name: "BoltNew", url: "https://bolt.new/"},
